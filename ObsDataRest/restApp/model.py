from ... import dbModel.model
from flask_restful import Resource

model_classes = {
    'User': dbModel.model.UserModel,
    'DataSources': dbModel.model.DataSourcesModel,
    'DataTypes': dbModel.model.DataTypesModel,
    'Data': dbModel.model.DataModel
}
...
class Data(_ODRBase):
    ...
    def get(self, _source, _type, _end_date = None, _start_date = None):
        ...
        objs = dbModel.model.db.session.query(self._model)\
...
api.add_resource(Dates,
        '/data/dates'
    )
class Dates(Resource):
    def get():
        logging.info('%s.%s()' % ('Data', 'get_dates'))
        subquery = dbModel.model.db.session.query(
        ...
        final_query = dbModel.model.db.session.query(
        ...
        results = dbModel.model.db.session.query(final_query).all()
